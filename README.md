...
- `v0.6` adds knowledge-quality controls, source trust indicators, project health summaries, safe suspect-row review/export tooling, and a validated multi-cycle runtime harness
...
- [CrispyBrain v0.6](docs/crispybrain-v0_6.md) - quality/control release summary, limitations, and runtime validation notes
